...
if(@$_GET['fdid'] && $_SESSION['key']=='harsh8252659801') {
$id=@$_GET['fdid'];
...
//delete user
if(isset($_SESSION['key'])){
if(@$_GET['demail'] && $_SESSION['key']=='harsh8252659801') {
$demail=@$_GET['demail'];
...
//remove quiz
if(isset($_SESSION['key'])){
if(@$_GET['q']== 'rmquiz' && $_SESSION['key']=='harsh8252659801') {
$eid=@$_GET['eid'];
...
//add quiz
if(isset($_SESSION['key'])){
if(@$_GET['q']== 'addquiz' && $_SESSION['key']=='harsh8252659801') {
$name = $_POST['name'];
...
//add question
if(isset($_SESSION['key'])){
if(@$_GET['q']== 'addqns' && $_SESSION['key']=='harsh8252659801') {
$n=@$_GET['n'];
$eid=@$_GET['eid'];
$ch=@$_GET['ch'];
...
else if( $_SESSION['key']!='harsh8252659801')
{
...
$sn--;
header("location:account.php?q=quiz&step=2&eid=$eid&n=$sn&t=$total&x=1")or die('Error152');
}
